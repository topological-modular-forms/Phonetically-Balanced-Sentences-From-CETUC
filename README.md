...
This repository is an attempt to recompile the 1000 phonetically balanced sentences from the article
...
I wasn't able to access the original dataset via [http://www.lps.ufrj.br/voz/1000frases](http://www.lps.ufrj.br/voz/1000frases) (it gave me an ```Error: 504 Gateway Time-out```). However, the CETUC dataset contains the sentences uncapitalized and without punctuation. Below you can find manually modified versions to add these back, whereas the sentences as extracted from CETUC can be find [here](). See the Portuguese StackExchange question [Is there an equivalent of the Harvard sentences for Brazillian Portuguese?](https://portuguese.stackexchange.com/questions/9768) for more details.

## Capitalized + Punctuated Sentences
...
0796. Há algo de maravilhoso e de assustador nessa ideia.
